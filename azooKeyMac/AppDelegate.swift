...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func openConfigWindow() {
        if let configWindow {
            ...
            // Create a new window
            (self.configWindow, self.configWindowController) = Self.buildSwiftUIWindow(ConfigWindow(), title: NSLocalizedString("window.settings", comment: "Settings window title"))
        }
    }
    ...
    func openUserDictionaryEditorWindow() {
        if let userDictionaryEditorWindow {
            ...
            (self.userDictionaryEditorWindow, self.userDictionaryEditorWindowController) = Self.buildSwiftUIWindow(UserDictionaryEditorWindow(), title: NSLocalizedString("window.settings", comment: "Settings window title"))
        }
    }
