...
struct PromptInputView: View {
    ...
    private func loadPromptHistory() {
        ...
        if let data = UserDefaults.standard.data(forKey: "ai.kizuna.inputmethod.XiaoLiIME.preference.PromptHistory") {
        ...
        let historyString = UserDefaults.standard.string(forKey: "ai.kizuna.inputmethod.XiaoLiIME.preference.PromptHistory") ?? ""
    ...
    private func savePinnedHistory() {
        if let data = try? JSONEncoder().encode(promptHistory) {
            UserDefaults.standard.set(data, forKey: "ai.kizuna.inputmethod.XiaoLiIME.preference.PromptHistory")
        }
    }
