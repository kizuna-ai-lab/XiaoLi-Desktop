...
extension Config {
    public struct ZenzaiProfile: StringConfigItem {
        ...
        public static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.ZenzaiProfile"
    }
}
...
extension Config {
    ...
    public struct OpenAiModelName: StringConfigItem {
        ...
        public static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.OpenAiModelName"
    }
    ...
    public struct OpenAiApiEndpoint: StringConfigItem {
        ...
        public static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.OpenAiApiEndpoint"
    ...
    struct PromptHistory: StringConfigItem {
        static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.PromptHistory"
    }
}
