...
extension Config.Deprecated {
    ...
    struct TypeCommaAndPeriod: BoolConfigItem {
        ...
        static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.typeCommaAndPeriod"
    }
    ...
    struct ZenzaiIntegration: BoolConfigItem {
        ...
        static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.enableZenzai"
    }
    ...
    struct EnableOpenAiApiKey: BoolConfigItem {
        static let `default` = false
        static let key: String = "ai.kizuna.inputmethod.XiaoLiIME.preference.enableOpenAiApiKey"
    }
}
